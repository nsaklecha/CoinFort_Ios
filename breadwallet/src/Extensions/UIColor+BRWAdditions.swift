...
extension UIColor {
    ...
    static var secondaryBorder: UIColor {
        return UIColor(red: 23.0/255.0, green: 28.0/255.0, blue: 24.0/255.0, alpha: 1.0)
    }
    ...
    static var gradientStart: UIColor {
        return UIColor(red: 241.0/255.0, green: 147.0/255.0, blue: 26.0/255.0, alpha: 1.0)
    }
