...
class AccountHeaderView : UIView, GradientDrawable, Subscriber {
    ...
    private let equals = UILabel(font: .customBody(size: smallFontSize), color: .blackTint)
    ...
    private func addConstraints() {
        ...
        search.constrain([
            ...
            search.constraint(.width, constant: 0.0),
            search.constraint(.height, constant: 0.0) ])
        search.imageEdgeInsets = UIEdgeInsetsMake(0.0, 0.0, 0.0, 0.0)
