...
class StartViewController : UIViewController {
    ...
    //MARK: - Private
    private let message = UILabel(font: .customMedium(size: 18.0), color: .blackTint)
  ...
  //  private let recover = ShadowButton(title: S.StartViewController.recoverButton, type: .secondary)
    ...
    private func addConstraints() {
        ...
        create.constrain([
           create.constraint(.leading, toView: view, constant: C.padding[2]),
            create.constraint(.bottom, toView: view, constant: -C.padding[3]),
            create.constraint(.trailing, toView: view, constant: -C.padding[2]),
        ...
        //create.constrain([
         ...
         //   create.constraint(.width, toView: remove, constant: nil),
       // create.constraint(.height, constant: C.Sizes.buttonHeight) ])
//        faq.constrain([
